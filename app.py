...
if not st.session_state.logado:
    ...
    with col1:
        ...
        if st.button("Cadastrar"):
            # Permitir cadastro mesmo sem código apenas para "Guilherme Ferreira"
            if codigo_convite not in CODIGOS_VALIDOS and novo_user.strip() != "Guilherme Ferreira":
        ...
        # Botão de reset (apenas para testes ou administração)
